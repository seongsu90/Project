...
<!--start-slider-->
	<div class="slider-bg">
				...
				<!--- banner Slider starts Here --->
	  			<script src="/ourapp/resources/js/responsiveslides.min.js"></script>
			 <script>
				 ...
				 <div class="wel-grid">
				   <div class="col-md-4 welcome-text">
					...
					<div class="col-md-8 welcome-img">
					   <img src="/ourapp/resources/img/img_03.jpg" class="img-responsive" alt="" />
					</div>
				   <div class="clearfix"> </div>
			   </div>
			    <div class="about-grid">
				   <div class="col-md-4 about-img">
					   <img src="/ourapp/resources/img/img_02.jpg" class="img-responsive" alt="" />
					</div>
		   ...
		   <div class="container">
				 ...
				 <div class="blog">
				   <div class="col-md-4 blog-text">
					...
					<div class="col-md-8 welcome-img">
					 <a href="single.html" class="mask"><img src="/ourapp/resources/img/b2.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div>
			    <div class="blog">
				 <div class="col-md-4 blog-text two">
					...
					<div class="col-md-8 blog-img two">
					 <a href="single.html" class="mask"><img src="/ourapp/resources/img/b3.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div> 
			    <div class="blog">
				   <div class="col-md-4 blog-text">
					...
					<div class="col-md-8 welcome-img">
					 <a href="single.html" class="mask"><img src="/ourapp/resources/img/b1.jpg" alt="image" class="img-responsive zoom-img"></a>
					</div>
				   <div class="clearfix"> </div>
			   </div>
		</div>
...
<!--gallery-->
	...
	<!--swipebox -->	
			<link rel="stylesheet" href="/ourapp/resources/css/swipebox.css">
				<script src="/ourapp/resources/js/jquery.swipebox.min.js"></script> 
