...
<%--
<%
import com.mycompany.ourapp.dto.Coolsms;

String api_secret = "B70068E0DD7DDA42ADC3FEDC9B3CB3FC";
...
%>	
--%>	
인증번호 : <input type="text" name="cnum" id="cnum"> <button id="checkcnum" onclick="checkcnum()">확인</button>